            ...
            ?>
                ...
                <div class="col-12 col-sm-12 col-md-6 mt-5 mb-5">
                    ...
                    ?>
                        ...
                        <div class="mx-auto bg-secondary card" style="text-align: center; width: 25rem; height: 20rem;">
                        ...
                        if (isset($_SESSION['tipo'])) :
                            ...
                            ?>
                                ...
                                <div class="mx-auto bg-secondary card" style="text-align: center; width: 25rem; height: 22rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-5 col-sm-5 col-md-5 mb-5">
                                    ...
                                    <div class="col-7 col-sm-7 col-md-7">
                                        ...
                                        <h5 class="inicioSubasta mt-3">Inicio: </h5>
                                        <p><?php echo $subasta['fechaInicioSubasta'] . "h" ?></p>
                                        <h5 class="finSubasta mt-3">Fin: </h5>
                                        <p><?php echo $subasta['fechaFinSubasta'] . "h" ?></p>
                                        ...
                                        ?>
                                                <a class="btn btn-dark" href=<?php echo 'index.php?controller=obras&action=subastaObra&id=' . $idSubasta ?> type="submit">Pujar</a>
                                        ...
                                        if (isset($_SESSION['tipo'])) :
                                            ...
                                            ?>
                                                ...
                                                <a class="btn btn-danger" href=<?php echo 'index.php?controller=obras&action=eliminarSubastas&id=' . $idSubasta ?> type="submit">Eliminar</a>
                                                <a class="btn btn-dark" href=<?php echo 'index.php?controller=obras&action=subastaObra&id=' . $idSubasta ?> type="submit">Detalles</a>
